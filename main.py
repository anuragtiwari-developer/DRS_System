...
btn = tkinter.Button(window, text="<< Previous (fast)", width=70, command=partial(play, -25))
btn.pack()

btn = tkinter.Button(window, text="<< Previous (slow)", width=70, command=partial(play, -2))
btn.pack()
...
btn = tkinter.Button(window, text="Give Out", width=70, command=out)
btn.pack()

btn = tkinter.Button(window, text="Give Not Out", width=70, command=not_out)
btn.pack()
window.mainloop()
